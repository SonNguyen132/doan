         ...
         <div class="container">
            <div class="row">
               <div class="col-md-2 col-sm-2">
                  <div class="logo"><a href="index.php"><img src="../assets/images/logo.png" alt="FlatShop"></a></div>
               </div>
                  ...
                  <div class="header_bottom">
                     <div class="navbar-collapse ">
                        <ul class="nav navbar-nav">
                           ...
                           <li><a href="productlist.php">women</a></li>
                           <li class="dropdown">
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="fbl-box leftbar">
                    ...
                    <a href="checkout2.php">Facebook social plugin</a>
                  </div>
                </div>
                <div class="col-md-9">
                              ...
                              <div class="col-md-6 col-sm-6">
                                <div class="your-details">
                                  ...
                                  <div class="form-row">
                                    ...
                                    <input type="text" class="input namefild" name="firstname">
                                  </div>
                                  <div class="form-row">
                                    <label class="lebel-abs">
                                    Last Name 
                                    ...
                                    <input type="text" class="input namefild" name="lastname">
                                  </div>
                                  ...
                                  <div class="form-row distance">
                                    ...
                                    <input type="text" class="input namefild" name="fax">
                                  </div>
                                  <div class="form-row distance">
                                    <label class="lebel-abs">
                                      Company 
                                    ...
                                    <input type="text" class="input namefild" name="company">
                                  </div>
                                  <div class="pass-wrap">
                                    <div class="form-row distance2">
                                      ...
                                      <input type="password" class="input namefild" name="yourpassword">
                                    </div>
                                    <div class="form-row distance1">
                                      ...
                                      <input type="password" class="input cpass" name="confirdyourpassword">
                                    </div>
                                  </div>
                                  <p>
                              ...
                              <div class="col-md-6 col-sm-6">
                                <div class="your-details">
                                  ...
                                  <div class="form-row">
                                    ...
                                    <input type="text" class="input namefild" name="address01">
                                  </div>
                                  <div class="form-row">
                                    <label class="lebel-abs">
                                      Address 02
                                    ...
                                    <input type="text" class="input namefild" name="address02">
                                  </div>
                                  <div class="form-row distance">
                                    <label class="lebel-abs">
                                      City 
                                  ...
                                  <div class="form-row distance3">
                                    ...
                                    <input type="text" class="input namefild" name="regionstate">
                                  </div>
                                  <p class="privacy">
                                    <span class="input-radio">
                                      <input type="radio" name="user">
